...
import com.xly.mall.common.base.user.CommonCache;
...
public class ConverterUtil {
    ...
    public static final <T> T copy(Object o, Class<T> clazz){
     ...
     * @return
     */
    public static final <T> List<T> convertOneFiledToList(List srcList , String filedName , Class<T> clazz){
        ...
        for(Object o : srcList){
            ...
            for(Field field : fields){
                ...
                if(filedName.equals(field.getName())){
                    Assert.isTrue(field.getType().getName().equals(clazz.getName()),"转换类型不一致");
                    T t = null;
                    try {
                        t = (T)(field.get(o));
