...
//        generateDomains("erp_customer");
        generateDomainsByDir("mall_user_login_log","userLoginLog");//        generateDomainsByDir("erp_purchase_apply_order_material","purchaseApply");
...
//        System.out.println(xmlDir);
    ...
    private static String URL = "jdbc:mysql://47.98.175.20:3306/mall_develop?useUnicode=true&amp;characterEncoding=UTF-8";
...
//        String doDir = System.getProperty("user.dir")+"/erp-dataaccess/src/main/java/com/lxzl/erp/dataaccess/domain"+dir+File.separator;
//        String xmlDir = System.getProperty("user.dir")+File.separator+"erp-dataaccess"+File.separator+"src"+File.separator+"main"+File.separator+"resources"+File.separator+"sqlmap"+File.separator;
        String poDir = System.getProperty("user.dir")+"\\mall-common\\src\\main\\java\\com\\xly\\mall\\common\\domain\\"+dir+File.separator+"pojo"+File.separator;
        String mapperDir = System.getProperty("user.dir")+"\\mall-dataaccess\\src\\main\\java\\com\\xly\\mall\\dataaccess\\dao\\mysql\\"+dir+File.separator;
        String doDir = System.getProperty("user.dir")+"\\mall-dataaccess\\src\\main\\java\\com\\xly\\mall\\dataaccess\\domain\\"+dir+File.separator;
        String xmlDir = System.getProperty("user.dir")+File.separator+"mall-dataaccess"+File.separator+"src"+File.separator+"main"+File.separator+"resources"+File.separator+"sqlmap"+File.separator;
    ...
    public static String getPoStringByDir(String dataImport , String bigDecimalImport , List<NameAndType> nameAndTypeList , Table table,String dir){
        ...
        StringBuffer poSb = new StringBuffer(
                "package com.xly.mall.common.domain."+dir+".pojo;\n\n" +
    ...
    public static String getDoStringByDir(String dataImport , String bigDecimalImport , List<NameAndType> nameAndTypeList , Table table,String dir){
        StringBuffer doSb = new StringBuffer(
                "package com.xly.mall.dataaccess.domain."+dir+";\n\n"+
                        "import com.xly.mall.dataaccess.domain.base.BaseDO;\n"+
                        dataImport+"\n" +bigDecimalImport+"\n" +
                        "\n" +
    ...
    public static String getMapperStringByDir(Table table,String dir){
        StringBuffer mapperSb = new StringBuffer(
                "package com.xly.mall.dataaccess.dao.mysql."+dir+";\n\n"+
                        "import com.xly.mall.dataaccess.dao.mysql.base.BaseMysqlDAO;\n"+
                        "import com.xly.mall.dataaccess.domain."+dir+"."+table.doTableName+";"
        );
    ...
    public static String getMapperString(Table table){
        StringBuffer mapperSb = new StringBuffer("import com.xly.mall.dataaccess.dao.mysql.base.BaseMysqlDAO;\n");
    ...
    public static String getXmlStringByDir(List<NameAndType> nameAndTypeList , Table table,String dir){
        String mapperName = table.poTableName+"Mapper";
        String mapperPackage = "com.xly.mall.dataaccess.dao.mysql."+dir+"."+mapperName;
        String doPackage = "com.xly.mall.dataaccess.domain."+dir+"."+table.doTableName;
