...
public class DynamicDataSourceAspect {
    ...
    @Pointcut("@annotation(com.xly.mall.common.base.db.dbInterface.DynamicDataSource)")
    public void dynamicDataSourceMethodCut() {}

    @Pointcut("@within(com.xly.mall.common.base.db.dbInterface.DynamicDataSource)")
